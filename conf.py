# -*- coding: utf-8 -*-
#
# The Open-PSA Model Exchange Format documentation build configuration file, created by
...
contributors = ', and '.join((', '.join(contributors[:-1]), contributors[-1]))
...
#
latex_appendices = ['mef/mef_schema', 'mef/mef_ebnf']
